...
export const vi = {
  app: {
    ...
    groupBillDefault: 'Bill cầu lông',
    playerList: 'Danh sách người chơi',
    playerLedgerGreeting: 'Trang cá nhân',
    totalOwed: 'Tổng cần trả',
    payNow: (amount: string) => `Trả ${amount}`,
    allPaid: 'Đã trả xong ✅',
    unpaidList: 'Chưa thanh toán',
    paidList: (n: number) => `Đã thanh toán (${n})`,
    billDefault: 'Bill cầu lông',
    // Payment page
    ...
    qrExpired: 'QR đã hết hạn (sau 24h). Tạo QR mới?',
    createNewQR: 'Tạo QR mới',
